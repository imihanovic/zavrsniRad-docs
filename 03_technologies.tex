...
NuGet (engl. \textit{NuGet Package Manager}) alat je za upravljanje paketa u ASP.NET okviru. Korišten je za instalaciju paketa (biblioteka) koji su potrebni pri izradi aplikacije. Pakete je moguće izraditi pomoću NuGet aplikacije i pohraniti ih u privatni ili javni repozitorij kao ZIP datoteke s ekstenzijom .nupack ili .nupkg\cite{nuGet}.
\begin{figure}[H]
